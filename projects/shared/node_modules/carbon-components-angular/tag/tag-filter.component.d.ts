...
export declare class TagFilter extends Tag {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TagFilter, "cds-tag-filter, ibm-tag-filter", never, { "closeButtonLabel": "closeButtonLabel"; "disabled": "disabled"; "title": "title"; }, { "close": "close"; "click": "click"; }, never, ["[cdsTagIcon],[ibmTagIcon]", "*"], false>;
}
