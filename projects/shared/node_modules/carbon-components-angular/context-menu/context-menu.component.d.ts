/**
 *
 * carbon-angular v0.0.0 | context-menu.component.d.ts
 *
...
export declare class ContextMenuComponent implements OnChanges {
    ...
    get classIcons(): HTMLElement;
    constructor(elementRef: ElementRef);
    ngOnChanges(changes: SimpleChanges): void;
    focusMenu(): void;
    handleNavigation(event: KeyboardEvent): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<ContextMenuComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<ContextMenuComponent, "cds-context-menu, ibm-context-menu", never, { "open": "open"; "position": "position"; }, {}, never, ["*"], false>;
}
