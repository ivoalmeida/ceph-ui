...
export class CrushRuleService {
  ...
  formTooltips = {
    ...
    root: `The name of the node under which data should be placed.`,
    failure_domain: `The type of CRUSH nodes across which we should separate replicas.`,
    device_class: `The device class on which to place data.`
  };
